...
tldr_actions:
  - "Evaluate agentic AI security posture against LLM01 (prompt injection) and LLM08 (excessive agency) risks."
  - "Implement inference API monitoring and access controls for frontier model deployments."
  - "Align AI capability roadmaps with proportional security investment and human-in-the-loop safeguards."
