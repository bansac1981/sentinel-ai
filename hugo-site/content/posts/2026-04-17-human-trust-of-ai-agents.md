---
title: "LLM Agents Exploit Human Over-Trust in Strategic Games"
...
tldr_actions:
  - "Audit human-LLM interaction protocols for over-trust bias in adversarial settings."
  - "Add explicit adversarial red-teaming against LLM agents before deployment."
  - "Train decision-makers to treat LLM partners as potentially uncooperative competitors."
